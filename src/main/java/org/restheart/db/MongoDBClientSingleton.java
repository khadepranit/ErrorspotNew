...
public class MongoDBClientSingleton {
    ...
    private MongoDBClientSingleton() {
        ...
        //if class variables initialized with config parameters, then proceed to create MongoClient instance by calling setup()
        try {
            setup();
     ...
     * @param conf
     */
    //this is static method called using classname. init() called from Bootstrapper() to provide config parameters
    ...
    private void setup() throws UnknownHostException {
        if (isInitialized()) {
            ...
            //an instance of MongoClient created with necessary config parameters
    ...
    public static String getErrorSpotConfig(String param){
    	 logger.info("Entering getErrorSpotConfig() in MongoDBSingleton: " + param);
